...
public class TesterMain {
    ...
    public static void main(String[] args){
        ...
        required128B.put(Student.Major.LMOR, false); //because LMOR can just take 128A as their one class
        ...
        required128C.put(Student.Major.LAMA, false); //because LAMA can take 128A,B as their two classes
        required128C.put(Student.Major.LMOR, false); //because LMOR can just take 128A as their one class
